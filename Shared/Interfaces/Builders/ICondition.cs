...
public interface ICondition<out TBuilder, T> : IComparisonCondition<TBuilder, T>, IBoolCondition<TBuilder, T>,
    ICollectionCondition<TBuilder, T>, IStringCondition<TBuilder, T>, IDateTimeCondition<TBuilder, T>,
    INumberCondition<TBuilder, T>
{
    /// <summary>
